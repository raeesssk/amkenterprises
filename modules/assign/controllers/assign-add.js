...
angular.module('assign').controller('assignAddCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $timeout, $filter) { 	
	

  $('.index').removeClass("active");
  $('#assignindex').addClass("active");
  $('#assignaddindex').addClass("active");
    ...
    $scope.getSerialNo = function() {
        $http({
          method: 'GET',
          url: $rootScope.baseURL+'/assign/serial/no',
          //data: $scope.data,
        ...
        {
            if(orderno.length >0)
                $scope.assign.am_invoice_no = parseInt(orderno[0].am_invoice_no) + 1;
            else
                $scope.assign.am_invoice_no = 1;
        })
        .error(function(data) 
        {   
...
//type a head
    ...
    $scope.addNozToCart = function(){
        ...
        // else if($('#anm_rate').val() == undefined || $('#anm_rate').val() == ""){
        //     var dialog = bootbox.dialog({
        //     message: '<p class="text-center">please enter rate.</p>',
        //         closeButton: false
        //     });
        //     dialog.find('.modal-body').addClass("btn-danger");
        //     setTimeout(function(){
        ...
        {
            $scope.selectedNozzleList.push($scope.nozzleObj);
        ...
        else if($scope.selectedProductList.length == 0 && $scope.selectedNozzleList.length==0)
        {
            ...
            setTimeout(function(){
                ...
                $('#btnsave').text("please wait...");
                    ...
                    $http({
                      method: 'POST',
                      url: $rootScope.baseURL+'/assign/add',
                    ...
                    {   
                        var dialog = bootbox.dialog({
                        message: '<p class="text-center">Assign Added Successfully!</p>',
                            closeButton: false
                        });
                          ...
                          "<table width='100%'>"+
                            ...
                            "<tr>"+
                              ...
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assign.am_emp_id.emp_name+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='30%' style='text-align:left; padding: 4px; border-style: none solid none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assign.am_emp_id.emp_address+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='30%' style='text-align:left; padding: 4px; border-style: none solid none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assign.am_emp_id.emp_mobile+"</strong>"+
                              "</td>"+
                            "</tr>"+
                          "</table>"+
                      "</td>" +
                  ...
                  "<table width='100%'>" +
                    "<thead>"+
                      "<tr>"+      
                        ...
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Opening Bal.</th>" +
                      "</tr>"+
                    "</thead>"+
                    " "+$('#contentNozzle').html()+" " +
                  "</table>"+
