// import admin
angular.module('report').controller('purchaseReportCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter) {


  $('.index').removeClass("active");
  $('#reportindex').addClass("active");
  $('#reportpurchaseindex').addClass("active");
...
$scope.apiURL = $rootScope.baseURL+'/dashboard/purchasereport/total';
   ...
   $scope.getAll = function () {
    ...
    $scope.resetpagination = function () {
        ...
        if ($scope.filterUser >= $scope.purchaseListcount)
            $scope.filterUser = $scope.purchaseListcount;
              ...
              $http({
                method: 'POST',
                url: $rootScope.baseURL+'/dashboard/purchasereport/limit',
                data: $scope.limit,
                headers: {'Content-Type': 'application/json',
                          'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
              })
    ...
    $scope.getAllDetails = function(){
        $scope.allList = [];
          $http({
          method: 'POST',
          url: $rootScope.baseURL+'/dashboard/purchasereport',
          data: $scope.limit,
          headers: {'Content-Type':'application/json',
                  'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
        })
      ...
      .success(function(salePurchaseList)
      {
        // $scope.saleProductList = angular.copy(saleProductList);
         ...
         var i = 1;
          ...
          $scope.convertNumberToWords($scope.purchases.prm_total_amount);
      })
      .error(function(data) 
      {   
        var dialog = bootbox.dialog({
           ...
           "<table width='100%' height='98%'>" +
                          ...
                          "<table width='100%'>"+
                            ...
                            "<tr>"+
                              ...
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.purchases.vm_firm_name+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='30%' style='text-align:left; padding: 4px; border-style: none solid none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.purchases.vm_address+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='30%' style='text-align:left; padding: 4px; border-style: none solid none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.purchases.vm_mobile+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='30%' style='text-align:left; padding: 4px; border-style: none solid none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.purchases.vm_gst_no+"</strong>"+
                              "</td>"+
                            "</tr>"+
                          "</table>"+
                      "</td>" +
                      "<td width='40%' style='text-align:left; padding: 4px; border-style: solid solid none none; border-width:1px; font-size:10pt;' valign='top'>" +
                          "<table width='100%'>"+
                            ...
                            "<tr>"+
                              ...
                              "</td>"+
                              "<td width='50%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.purchases.prm_invoice_no+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='50%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                            ...
                            "<tr>"+
                              ...
                              "</td>"+
                              "<td width='50%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.purchases.prm_credit+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='50%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='50%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.purchases.prm_inward_no+"</strong>"+
                              "</td>"+
                            "</tr>"+
                          "</table>"+
                      "</td>" +
            ...
            "<tr>" +
              ...
              "<tr>"+
                  ...
                  "<td width='10%' style='padding:4px; font-size:10pt; border-style: solid; border-width:1px;'><strong>"+$filter('number')($scope.purchases.prm_total_amount, "3")+"</strong></td>" +
              "</tr>"+
              "<tr>"+
              ...
              "<tr>"+
                "<td valign='top' style=' border-style: solid; border-width:1px;'>"+
                  "<table width='100%'>" +
                    "<thead>"+
                      "<tr>"+      
                        "<th style='padding:10px; border-style: none solid solid none; border-width:1px;'>Purchase No.</th>" +
