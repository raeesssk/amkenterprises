// import admin
angular.module('productprice').controller('productpriceCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter) {
...
$scope.apiURL = $rootScope.baseURL+'/productprice/productprice/total';
    ...
    $scope.resetpagination = function () {
        ...
        if ($scope.filterUser >= $scope.productpriceListcount)
            $scope.filterUser = $scope.productpriceListcount;
              ...
              $http({
                method: 'POST',
                url: $rootScope.baseURL+'/productprice/productprice/limit',
                data: $scope.limit,
                headers: {'Content-Type': 'application/json',
                          'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
              })
              .success(function(productprice)
              {
                ...
                if (productprice.length > 0) {
                  ...
                  productprice.forEach(function (value, key) {
