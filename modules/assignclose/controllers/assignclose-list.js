// import admin
angular.module('assignclose').controller('assigncloseCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter) {
  ...
  $scope.filteredTodos = [];
    ...
    $scope.numPerPage = 10;
    $scope.obj_Main = [];
    $scope.assigncloseListcount = 0;
    $scope.loading1 = 0;
    $scope.parseFloat = parseFloat;
    $scope.limit = {};

 $scope.apiURL = $rootScope.baseURL+'/assignclose/assignclose/total';
      $scope.getAll = function () {
          ...
          .success(function(category)
          {
            category.forEach(function (value, key) {
                $scope.assigncloseListcount=value.total;
            });
    ...
    $scope.resetpagination = function () {
        ...
        if ($scope.filterUser >= $scope.assigncloseListcount)
            $scope.filterUser = $scope.assigncloseListcount;
              ...
              $http({
                method: 'POST',
                url: $rootScope.baseURL+'/assignclose/assignclose/limit',
                data: $scope.limit,
                headers: {'Content-Type': 'application/json',
                          'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
              })
    ...
    $scope.deleteAssignClose = function (acm_id) {
      $scope.acm_id=acm_id;
    }  
    ...
    $scope.deleteConfirm = function () {
        ...
        $('#del').text("please wait...");
	     $http({
	      method: 'POST',
	      url: $rootScope.baseURL+'/assignclose/delete/'+$scope.acm_id,
	      headers: {'Content-Type': 'application/json',
                  'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
	    })
    ...
    $scope.reopenAssignClose = function (am_id) {
    ...
    $scope.reopenConfirm = function () {
       ...
       $http({
        method: 'POST',
        url: $rootScope.baseURL+'/assignclose/reopen/'+$scope.am_id.acm_id,
        data: $scope.am_id,
        headers: {'Content-Type': 'application/json',
                  'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
      })
      .success(function(saleObj)
      {
          if(saleObj == 'Close')
          {
              ...
              var dialog = bootbox.dialog({
              message: '<p class="text-center">Already created for the assign.</p>',
                  closeButton: false
              });
              setTimeout(function(){
                  $('#reopen').text("Reopen");
  ...
  $scope.viewQuatationDetails = function (index) {
      ...
      $scope.assigncloses = $scope.filteredTodos[index];
      
      $http({
        method: 'GET',
        url: $rootScope.baseURL+'/assignclose/details/'+$scope.filteredTodos[index].acm_id,
        headers: {'Content-Type': 'application/json',
                  'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
      })
      .success(function(salePurchaseList)
      {
          ...
          $http({
            method: 'GET',
            url: $rootScope.baseURL+'/assignclose/nozzle/details/'+$scope.filteredTodos[index].acm_id,
            headers: {'Content-Type': 'application/json',
                      'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
          })
          .success(function(saleNozzleList)
          {
              ...
              $scope.convertNumberToWords($scope.assigncloses.amount);
          })
          .error(function(data) 
          {   
            var dialog = bootbox.dialog({
      ...
      $http({
        method: 'GET',
        url: $rootScope.baseURL+'/assignclose/details/payment/'+$scope.filteredTodos[index].acm_id,
        headers: {'Content-Type': 'application/json',
                  'Authorization' :'Bearer '+localStorage.getItem("amkenterprises_admin_access_token")}
      })
      .success(function(salePurchaseList)
    ...
    $scope.printDetails = function(){
      ...
      if($scope.assigncloses.acm_status == 1){
          ...
          "<body onload='window.print()'>" +
           ...
           "<table width='100%' height='98%'>" +
                          ...
                          "<table width='100%'>"+
                            ...
                            "<tr>"+
                              ...
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assigncloses.emp_name+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='30%' style='text-align:left; padding: 4px; border-style: none solid none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assigncloses.emp_address+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='30%' style='text-align:left; padding: 4px; border-style: none solid none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='70%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assigncloses.emp_mobile+"</strong>"+
                              "</td>"+
                            "</tr>"+
                          "</table>"+
                      "</td>" +
                          ...
                          "<table width='100%'>"+
                            ...
                            "<tr>"+
                              ...
                              "<td width='60%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assigncloses.am_invoice_no+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='40%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                              ...
                              "</td>"+
                              "<td width='60%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
                                "<strong>"+$scope.assigncloses.acm_invoice_no+"</strong>"+
                              "</td>"+
                            "</tr>"+
                            "<tr>"+
                              "<td width='40%' style='text-align:left; padding: 4px; border-style: none none none none; border-width:1px; font-size:10pt;'>"+
              ...
              "<tr>"+
                "<td colspan='12' valign='top' style=' border-style: solid; border-width:1px;'>"+
                  "<table width='100%'>" +
                    "<thead>"+
                      "<tr>"+
                      "  <th colspan='9' style='text-align: center; padding: 4px; font-size: 10pt; border-style: solid none solid none; border-width:1px;'>Nozzle Details</th>"+
                      "</tr>"+
                      "<tr>"+      
                        ...
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Opening Meter</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Closing Meter</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Testing</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Total Sale</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none none solid none; border-width:1px;'>Amount</th>" +
                      "</tr>"+
                    "</thead>"+
                    " "+$('#contentNozzle').html()+" " +
                  "</table>"+
                  "<table width='100%'>" +
                    "<thead>"+
                      "<tr>"+
                      "  <th colspan='7' style='text-align: center; padding: 4px; font-size: 10pt; border-style: solid none solid none; border-width:1px;'>Product Details</th>"+
                      "</tr>"+
                      "<tr>"+      
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Sr.No.</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Product</th> " +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Price</th>"+
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Opening Qty</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Closing Qty</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Total Sale</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none none solid none; border-width:1px;'>Amount</th>" +
                      "</tr>"+
                    "</thead>";
                  ...
                  "<table width='100%'>" +
                    "<thead>"+
                      "<tr>"+
                      "  <th colspan='3' style='text-align: center; padding: 4px; font-size: 10pt; border-style: solid none solid none; border-width:1px;'>Payment Details</th>"+
                      "</tr>"+
                      "<tr>"+      
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Sr.No.</th>" +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Payment Mode</th> " +
                        "<th style='text-align:center; padding: 4px; font-size: 10pt; border-style: none solid solid none; border-width:1px;'>Amount</th>"+
                      "</tr>"+
                    "</thead>"+
                    " "+$('#contentPay').html()+" " +
                  "</table>"+
            ...
            "<tr>" +
                  ...
                  "<td width='20%' style='padding:4px; font-size:10pt; border-style: none solid none none; border-width:1px;'><strong>"+$filter('number')($scope.assigncloses.amount, "3")+"</strong></td>" +
              "</tr>"+
              "<tr>"+
